...
void part1(int x) {
    ...
    printf("Explanation: x was being incremented before it was executed each time, resulting in it being incremented to 10 when result called isPositive and again when isPositive was executed.\n\n\n"); // (3 points)
}
...
void part2(int x, int y) {
    ...
    //increment the value before macro to eliminate the macro incrementing multiple times
    x_copy++;
    y_copy++;
    ...
    printf("Explanation: There can be many reasons why diffent values are being produced. They are different compilers and may be compiling the code differently or the setting and libraries i.ee #pragma\n\n"); //  (3 points)
}
